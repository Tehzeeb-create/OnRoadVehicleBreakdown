...
class MechanicDashboardActivity : FragmentActivity(), OnMapReadyCallback {
    private lateinit var auth: FirebaseAuth
    private lateinit var databaseReference: DatabaseReference
    private lateinit var fusedLocationProviderClient: FusedLocationProviderClient
    private val DEFAULT_ZOOM = 15.0f
    private val TAG = "MechanicDashboardActivity"
                        ...
                        userData?.let { user ->
                            ...
                            usersRef.setValue(updatedUser)
                                .addOnSuccessListener {
                                    Toast.makeText(
                                        this@MechanicDashboardActivity,
    ...
    fun addRandomMarkersAroundUserLocation(userLocation: LatLng) {
        val numberOfMarkers = 15
        val maxDistanceInMeters = 100000 // Adjust this distance as needed
        ...
        for (i in 0 until numberOfMarkers) {
            ...
            val carLogoBitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.car)
